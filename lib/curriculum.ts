...
export const LESSONS: Lesson[] = [
  ...
  // ── Stage 2 — Rhythm ────────────────────────────────────────────
  { slug: "rhythm-before-the-instrument", title: "Rhythm before the instrument", stage: 2, track: "ear", tag: "NOW" },
  { slug: "note-values", title: "How long each note lasts", stage: 2, track: "reading", tag: "NOW" },
  { slug: "dotted-notes", title: "Dotted notes", stage: 2, track: "reading", tag: "NOW" },
  { slug: "rests", title: "Rests — silence has a length too", stage: 2, track: "reading", tag: "NOW" },
  { slug: "beams-or-a-double-stop", title: "Two notes in a row, or two at once?", stage: 2, track: "reading", tag: "NOW" },
  { slug: "one-beam-two-beams", title: "One beam, two beams", stage: 2, track: "reading", tag: "NOW" },
  { slug: "ties-and-slurs", title: "Ties and slurs", stage: 2, track: "reading", tag: "NOW" },
  { slug: "time-signatures", title: "Time signatures", stage: 2, track: "reading", tag: "NOW" },
  { slug: "common-time", title: "Common time, and the C", stage: 2, track: "reading", tag: "NOW" },
  { slug: "counting-and-konnakol", title: "Counting — and counting in bols", stage: 2, track: "ear", tag: "NOW" },
  { slug: "syncopation-and-pickups", title: "Syncopation and pickups", stage: 2, track: "reading", tag: "NEXT" },
  { slug: "triplets", title: "Triplets and other tuplets", stage: 2, track: "reading", tag: "NEXT" },
  { slug: "reading-quarters-and-eighths", title: "Rhythm drill: quarters and eighths", stage: 2, track: "reading", tag: "NOW" },
  { slug: "reading-dotted-rhythms", title: "Rhythm drill: dotted feel", stage: 2, track: "reading", tag: "NOW" },
  { slug: "reading-mixed-rhythms", title: "Rhythm drill: mixed", stage: 2, track: "reading", tag: "NOW" },

  // ── Stage 3 — Score symbols ─────────────────────────────────────
  { slug: "tempo-words", title: "Tempo words", stage: 3, track: "reading", tag: "NOW" },
  { slug: "dynamics", title: "Dynamics", stage: 3, track: "reading", tag: "NOW" },
  { slug: "articulation", title: "Articulation marks", stage: 3, track: "reading", tag: "NOW" },
  { slug: "bow-direction-marks", title: "Bow-direction marks", stage: 3, track: "reading", tag: "NOW" },
  { slug: "string-words", title: "Words only string players see", stage: 3, track: "reading", tag: "NOW" },
  { slug: "repeats-and-navigation", title: "Repeats and navigation", stage: 3, track: "reading", tag: "NOW" },
  { slug: "ornaments", title: "Ornaments", stage: 3, track: "reading", tag: "NEXT" },
  { slug: "trills-turns-and-grace-notes", title: "Trills, turns and grace notes", stage: 3, track: "reading", tag: "NEXT" },
  { slug: "double-stops-and-chords-on-the-page", title: "Double stops and chords, on the page", stage: 3, track: "reading", tag: "NEXT" },
  { slug: "harmonics-and-pizzicato-marks", title: "Harmonics and pizzicato marks", stage: 3, track: "reading", tag: "REFERENCE" },
  { slug: "fingerings-and-position-numbers", title: "Fingerings — and position numbers aren't fingers", stage: 3, track: "reading", tag: "NOW" },
  { slug: "editions-and-editorial-marks", title: "Editions and editorial marks", stage: 3, track: "reading", tag: "REFERENCE" },
  { slug: "the-score-language-quiz", title: "The score-language quiz", stage: 3, track: "reading", tag: "NOW" },
